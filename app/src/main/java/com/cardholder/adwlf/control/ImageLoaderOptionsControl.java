package com.cardholder.adwlf.control;
...
public class ImageLoaderOptionsControl {
    public static  DisplayImageOptions getOptions(){
        DisplayImageOptions  options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.image_def) //设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.mipmap.image_def)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.mipmap.image_def)  //设置图片加载/解码过程中错误时候显示的图片
        ...
        DisplayImageOptions  options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.image_def_frgment1) //设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.mipmap.image_def_frgment1)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.mipmap.image_def_frgment1)  //设置图片加载/解码过程中错误时候显示的图片
                .cacheInMemory(true)//设置下载的图片是否缓存在内存中
                .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
                .imageScaleType(ImageScaleType.EXACTLY)//设置图片以如何的编码方式显示（控件大小）
                .bitmapConfig(Bitmap.Config.RGB_565)
    ...
    public static  DisplayImageOptions getCircleOptions(Context context){
        Bitmap bitmap = BitmapUtils.toRoundBitmap(BitmapFactory.decodeResource(context.getResources(), R.mipmap.image_def));
        ...
        DisplayImageOptions  options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.userhead) //设置图片在下载期间显示的图片
                .showImageForEmptyUri(R.mipmap.userhead)//设置图片Uri为空或是错误的时候显示的图片
                .showImageOnFail(R.mipmap.userhead)  //设置图片加载/解码过程中错误时候显示的图片
                .cacheInMemory(true)//设置下载的图片是否缓存在内存中
                .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
                .imageScaleType(ImageScaleType.EXACTLY)//设置图片以如何的编码方式显示（控件大小）
                .bitmapConfig(Bitmap.Config.RGB_565)
