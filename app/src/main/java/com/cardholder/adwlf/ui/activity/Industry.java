...
import com.cardholder.adwlf.adapter.EtypeAdapter;
import com.cardholder.adwlf.adapter.IndustryAdapter;
import com.cardholder.adwlf.bean.IIData;
import com.cardholder.adwlf.ebean.EType;
...
public class Industry extends SuperActivity {
    ...
    private List<com.cardholder.adwlf.ebean.Industry> industryList;
    private int flag;
    ...
    private void getIndustry(){
        List<com.cardholder.adwlf.ebean.Industry> industryList = IIData.getIIData().getIndustryList();
        if(null!= industryList&&industryList.size()>0){
            ...
            NetworkDownload.jsonGetForCode1(this, Constants.URL_SERVER_INTEREST, null, new NetworkDownload.NetworkDownloadCallBackJson() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONObject jsonObject) {
                    Industry.this.industryList.addAll(JsonUtils.getBeanList(jsonObject.optJSONArray("data"), com.cardholder.adwlf.ebean.Industry.class));
